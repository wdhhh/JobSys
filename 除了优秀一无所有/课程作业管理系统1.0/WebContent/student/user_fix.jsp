<%@ page language="java" import="kjzy.wangyu.user.*" pageEncoding="utf-8"%>
...
if(user.userLogin(nid,password)==4)
	{%>  
...
{
if(user.fix_password(request.getParameter("id").trim(),request.getParameter("password6"))==4)
{
